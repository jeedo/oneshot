...
|--------|-------|-------------|
| `check_docs.py` | `python3 scripts/check_docs.py` | Validate architecture.md, deployment.md, runbook.md, security-review.md and plan.md (required sections, numbering, TBD markers) |
